"""Tests for the Cloud & Lakehouse sprint (pyfunc). Runs in CI."""
...
TASKS = REPO / "projects/datamart-intelligence-platform/tasks/sprint-cloud"
ALL_TASKS = [
    ("scan-cost", "scan_cost.py"),
    ("partition-prune", "partition_prune.py"),
    ("medallion-silver", "to_silver.py"),
    ("delta-merge", "delta_merge.py"),
